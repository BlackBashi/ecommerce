...
class Order extends Model {
    ...
    public static function getErrorRegister(){
        $msg = (isset($_SESSION[Order::ERROR_REGISTER]) && $_SESSION[Order::ERROR_REGISTER]) ? $_SESSION[Order::ERROR_REGISTER] : '';
        Order::clearErrorRegister();
        return $msg;
    }

    public static function clearErrorRegister(){
        $_SESSION[Order::ERROR_REGISTER] = NULL;
    }
