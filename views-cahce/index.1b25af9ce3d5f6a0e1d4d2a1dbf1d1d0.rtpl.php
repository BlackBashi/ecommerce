...
<body>
    <div class="">
        ...
        <ol class="carousel-indicators">
            <li data-targert="#carousel" data-slide-to="0" class="active"></li>
            <li data-targert="#carousel" data-slide-to="1" ></li>
            <li data-targert="#carousel" data-slide-to="2" ></li>
            <li data-targert="#carousel" data-slide-to="3" ></li>
        </ol> 
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                ...
                <div class="item">    
                    <img src="res/site/img/h4-slide2.png" alt="">
					<div class="carousel-caption">
                            <h2 class="caption title">
                ...
                <div class="item"> 
                <img src="res/site/img/h4-slide3.png" alt="">
                    <div class="carousel-caption">
                            <h2 class="caption title">
